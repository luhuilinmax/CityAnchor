...
from model.util import mask_tokens
from model.util import get_mask
...
class Solver():
    ...
    def _feed(self, dataloader, phase, epoch_id):
        ...
        for data_dict in dataloader:
            ...
            '''
            print(query) #[16]
            print(data_dict['geo_len'])
            print(self.max_num_object)
            '''
            ...
            '''
            print(data_dict['input_ids']) #[16,72]
            print(data_dict['geo_mask'].shape) #[16,10]
            print(data_dict['geo_mask'])
            print(data_dict['attention_mask'].shape) #[16,72]
            print(data_dict['labels'].shape) #[16,72]
            print(r)
            '''
