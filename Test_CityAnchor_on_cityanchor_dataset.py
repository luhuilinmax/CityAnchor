...
def main(args):
    ...
    SCANREFER_VAL = json.load(open("./cityanchor_meta_val_97.json")) # Testing samples
    ...
    for i in range(len(scanrefer)):
        ...
        # change this
        raster_file = os.path.join("/content/drive/MyDrive/CityAnchor_data/map", scene_id+".tif")
        feat_file = os.path.join("/content/drive/MyDrive/CityAnchor_data/feat", scene_id+"_feat.json")
        bbox_file = os.path.join("/content/drive/MyDrive/CityAnchor_data/bbox", scene_id+"_bbox.json")
