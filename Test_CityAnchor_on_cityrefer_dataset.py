...
def main(args):
    ...
    import json
    SCANREFER_TRAIN = json.load(open(os.path.join("/content/drive/MyDrive/CityAnchor_Release_Data/meta_data/CityRefer_train_all_v1.json")))
    # SCANREFER_VAL = json.load(open("/CityRefer_val_NO_all.json")) 
    SCANREFER_VAL = json.load(open("/content/drive/MyDrive/CityAnchor_Release_Data/meta_data/CityRefer_val_NO.json")) 
    ...
    file_path = "/content/drive/MyDrive/CityAnchor_Release/vis_output/cityrefer_test_record.txt" # changing this to record grounding results
